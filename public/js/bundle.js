...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FuZGlwYW45OCIsImEiOiJjazZ1eTgyOWowOXM0M2xvYXVjejg4bWNlIn0.1wNtoDzXnaSkTM7yCzgdrA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/sandipan98/ck6vawcyb0e0e1io84chgqdda',
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'sign up in successfully!');
...
var stripe = Stripe('pk_test_6AjBzeyHizNzzQ3WpmBBzcyD00ilPbgxTE');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('success', 'Booking Done! All necessary information has been mailed to you.');
...
var bookBtn = document.getElementById('book-tour'); // window.alert('Application Loaded');
// DELEGATION
